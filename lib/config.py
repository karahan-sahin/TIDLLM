...
GLOBAL_CONFIG = {
    ...
    'MODEL_ENCODER_CONVOLUTIONAL_LAYERS': [
        {
            ...
            'in_channels': None, 'out_channels': 10,  'kernel_size': (1, 10, 10), 'stride': (1, 1, 1), 'padding': (1, 1, 1),  
            # Batch Normalization
            'batch_norm': True, 
            # Activation Function
            'activation': 'gelu', 
            # Pooling Layer 1: 10x10x10 -> 10x5x5
            'pooling': 'max', 'pooling_kernel_size': (1, 2, 2), 'pooling_stride': 1,
        },
        {
            # Convolutional Layer 2
            # CNN Layer 1: 1x10x10 -> 10x10x10
            'in_channels': 10, 'out_channels': 5,  'kernel_size': (1, 10, 10), 'stride': (1, 1, 1), 'padding': (1, 1, 1),  
            # Batch Normalization
            'batch_norm': True, 
            # Activation Function
            'activation': 'gelu', 
        ...
        },
        {
            ...
            # CNN Layer 1: 1x10x10 -> 10x10x10
            'in_channels': 5, 'out_channels': 2,  'kernel_size': (1, 10, 10), 'stride': (1, 1, 1), 'padding': (1, 1, 1),  
            # Batch Normalization
            'batch_norm': True, 
            # Activation Function
            'activation': 'gelu', 
    ...
    'MODEL_VQ_CODEBOOK': 8, # NUM OF RESIDUAL BLOCKS (CODEBOOKS) (NUM_QUANDRANTS = 2^CODEBOOK)
    ...
    'MODEL_DECODER_CONVOLUTIONAL_LAYERS': [
        {
            ...
            'in_channels': None, 'out_channels': 3, 'kernel_size': (3, 5, 5), 'stride': (1, 1, 1), 'padding': (1, 1, 1), 'output_padding': (1, 1, 1), 
            # Activation Function
            'activation': 'gelu',
            # Pooling Layer 1: 10x10x10 -> 10x5x5
            'pooling': 'avg', 'pooling_kernel_size': (2, 2, 2), 'pooling_stride': 1,
        },
        {
            # Convolutional Layer 2: 10x10x10 -> 10x10x10
            'in_channels': 3, 'out_channels': 3, 'kernel_size': (4, 5, 5), 'stride': (1, 2, 2), 'padding': (1, 1, 1), 'output_padding': (1, 1, 1), 
            # Activation Function
            'activation': 'gelu', 
            # Pooling Layer 2: 10x10x10 -> 10x5x5
            'pooling_kernel_size': (2, 2, 2), 'pooling_stride': 1,
        },
        {
            # Convolutional Layer 3: 10x10x10 -> 10x10x10
            'in_channels': 3, 'out_channels': None, 'kernel_size': (3, 15, 15),  'stride': (1, 2, 2), 'padding': (1, 1, 1),  'output_padding': (1, 1, 1), 
            # Activation Function
            'activation': 'gelu', 
    ...
    'MODEL_DECODER_LINEAR_LAYERS': [
        # Linear Layer 1: 10x5x5 -> 512
        { 'in_features': None, 'out_features': 512, 'activation': 'gelu', 'dropout': 0.5 },
        # ....
        # Linear Layer 2: 512 -> 512 (Output Layer) (Should be equal to MODEL_VQ_EMBED_DIM)
        { 'in_features': 512, 'out_features': None, 'activation': 'gelu', 'dropout': 0.5 },
    ],
